...
const productos = [
  { id: 1, nombre: "Poción Amour", categoria: "amour", descripcion: "Destilada bajo la luz tenue de una luna creciente, esta poción susurra antiguos encantos que despiertan los hilos invisibles del deseo y la pasion. Con una sola gota, los corazones olvidados recuerdan, los silencios se rompen, y el amor florece donde parecía marchito. Su aroma dulce y profundo permanece como un secreto compartido entre almas destinadas a cruzarse." },
